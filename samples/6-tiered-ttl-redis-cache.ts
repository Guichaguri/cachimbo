...
const localTTL = 1.5; // The amount of time items should remain cached in the in-memory cache
const ttl = 10; // The amount of time items should remain cached in Redis
