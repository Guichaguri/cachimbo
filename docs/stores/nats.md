...
- NATS KV only supports `[-/_=.a-zA-Z0-9]` characters in keys. Use a [Key Transformation](../layers/key-transformation.md) layer to hash keys or replace characters if yours may use them.
